...
- [x] 1.1 Add backed-up descriptor-scoped acquisition state and truthful PDF projections; test failures, stale state, successful recovery and unchanged research rows.
- [x] 1.2 Wire selected import to shared acquisition, expose exact-source retry and complete backend identity on the storage port; test partial success and alternate-backend dispatch.
- [x] 1.3 Update import/Library/Files views and decision-aware audit; verify build, API and disposable browser flows.

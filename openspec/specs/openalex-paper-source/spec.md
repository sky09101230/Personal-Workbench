# OpenAlex Paper Source Specification

## Purpose

Define bounded OpenAlex paper discovery, normalization, Topic matching, refresh isolation, caching, and Papers feed behavior for the News module.

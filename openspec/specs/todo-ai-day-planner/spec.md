# Todo AI Day Planner Specification

## Purpose

Define the replaceable TodoPlannerPort, cross-project Plan Proposal generation, review workflow, and the boundary that keeps generated suggestions separate from Tasks until the user explicitly accepts.

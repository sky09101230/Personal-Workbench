# Literature User Notes Specification

## Purpose

Define Workbench-local Literature notes and explicit user-controlled copying of AI outputs without Zotero write-back.

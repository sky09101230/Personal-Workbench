...
const labels: Record<string, string> = {
  ...
  owned_primary: "已保存主 PDF", owned_files: "已有受管 PDF 附件", source_only: "仅有 PDF 来源引用", needs_recovery: "PDF 待恢复 / 重试", none: "无 PDF",
  acquired: "已获取受管副本", already_owned: "已有受管副本", owned_copy: "已有校验通过的受管副本", owned_copy_missing: "受管副本缺失", owned_copy_corrupt: "受管副本校验失败", owned_copy_invalid: "受管副本记录无效", owned_copy_unreadable: "受管副本无法读取", owned_copy_unsupported_backend: "受管副本存储不可用",
  source_unavailable: "来源暂不可用 / 需恢复源文件", source_not_configured: "未配置来源", source_authentication_failed: "来源认证失败", source_descriptor_changed: "来源记录已变化，请重新尝试", planned_source_changed: "来源记录已变化，需重新规划", source_changed_during_download: "读取时来源发生变化", source_checksum_mismatch: "来源校验和不匹配", invalid_pdf_or_source_metadata: "PDF 或来源信息无效", size_limit: "超过来源文件大小上限", acquisition_failed: "文件获取失败", acquisition_state_unavailable: "无法记录文件获取状态",
  ...
  short_text: "可提取文字较少，请人工核对", missing_title: "未提取到标题", missing_doi: "未提取到 DOI", missing_authors: "未提取到作者", file_date_is_not_publication_date: "文件日期不等于出版年份", identifier_requires_review: "标识符需要人工核对", multiple_doi_candidates: "提取到多个 DOI 候选", ocr_used: "已使用 OCR 补充识别", doi_title_mismatch: "DOI 对应标题与文档标题不一致", doi_unverified: "DOI 未能在线核验", doi_metadata_unavailable: "DOI 元数据暂时不可用", doi_metadata_conflict: "DOI 元数据来源存在冲突",

...
- [ ] Goal completion audit and OpenSpec main-spec synchronization/archival review. Do not mark the Goal complete while missing source bytes or required recovery input remain unresolved.
